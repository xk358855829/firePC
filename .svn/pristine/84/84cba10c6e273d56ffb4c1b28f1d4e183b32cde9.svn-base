<template>
  <div id="PSTlist">
    ...
    <div class="select">
      ...
      <el-select v-model="search.personnel"
                 placeholder="请选择">
      ...
      <el-table class='oyTable'
        ...
        <el-table-column label="创建时间">
          <template slot-scope="scope">
            <el-popover trigger="hover"
                        placement="top">
              <p class="TsMaxWidth">{{timestamp(scope.row.createTime.time)}}</p>
              <div slot="reference"
                   class="name-wrapper">
                <div class="overflowHide">{{timestamp(scope.row.createTime.time)}}</div>
              </div>
            </el-popover>
          </template>
        </el-table-column>
        ...
        <el-table-column prop=""
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip class="item"
                        ...
                        content="解绑"
                        placement="top">
              <i class="icon-menu el-icon-sort"
...
export default {
  ...
  methods: {
    ...
    deleteClick (row) {
      ...
      this.$confirm('此操作将解绑平台账户, 是否继续?', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
